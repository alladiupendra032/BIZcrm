...
export function UserTable({ onUsersChange }: UserTableProps) {
  ...
  return (
    <>
      <div className="glass-panel border border-white/10 rounded-2xl overflow-hidden">
        {/* Table header */}
        <div className="grid grid-cols-[1fr_1fr_160px_40px] gap-4 px-4 py-3 border-b border-white/10 text-xs font-semibold text-slate-400 uppercase tracking-wider">
          <span>User</span>
          <span>Email</span>
          <span>Role</span>
          <span />
        ...
        {users.map((u, i) => {
          ...
          return (
            <motion.div
              ...
              className="grid grid-cols-[1fr_1fr_160px_40px] gap-4 items-center px-4 py-3.5 border-b border-white/5 hover:bg-white/3 transition-colors"
            >
              {/* Avatar + Name */}
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-3 py-1.5 rounded-lg text-sm focus:outline-none transition-colors disabled:opacity-50"
                  style={{
